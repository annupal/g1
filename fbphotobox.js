(function($) {
	...
	FBPhotoBox.prototype = {
		...
		initDOM: function() {
			...
			html += '<tr><td><div style="position:relative;display:inline-block;"><img class="fbphotobox-main-image" src="https://3.bp.blogspot.com/-fP-7dpPWZns/WG9Cr5JshwI/AAAAAAAADYA/PE7UbtP8XnU-E1boa3jIN5kxs0Sw_Ke4wCLcB/s1600/rakul%2Bpreet%2Bsingh.jpg"/></div></td></tr></table>';
			html += '<div class="fbphotobox-image-stage-overlay">';
			html += '<div class="fbphotobox-container-left-header">';
			html += '<a title="Full Screen" class="fbphotobox-fc-btn fbphotobox-a" style="background-image: url(https://4.bp.blogspot.com/-NO3tKWaFPzE/WHH4dJjOiHI/AAAAAAAADZI/1OBBtxq-hwAJaVNkM2HFVxvUoKyscHf_QCPcB/s1600/fullscreen.png);';
			...
			html += '<a class="fbphotobox-a" title="Previous" style="background-image: url(https://2.bp.blogspot.com/-5mYspFNDh3E/WHH4ccvuQrI/AAAAAAAADZI/guS6CJsmw_kKcCJEgB693L5BFmd95lufACPcB/s1600/Arrows-LWhite-icon.png);';
			...
			html += '<tr>';
			html += '<td style="vertical-align:middle;">';
			html += '<a class="fbphotobox-a" title="Next" style="background-image: url(https://3.bp.blogspot.com/-K5anz5tYQuU/WHH4ccH7RVI/AAAAAAAADZI/6QiPryGZ_z4Xk9-jqi_sHtVqhyzhRGbHQCPcB/s1600/Arrows-RWhite-icon.png);background-repeat: no-repeat;background-size:auto;';
			...
			html += '<img src="https://2.bp.blogspot.com/-VnZCK1tqIxg/WHH4chtRteI/AAAAAAAADZI/hu_uc7HpqIszpWd-QgVWM_Uw93u0j04AwCPcB/s1600/close.png" style="height:10px;width:10px"/>';
			html += '</a>';
			...
			html += '<a class="fbphotobox-a" title="Next" style="background-image: url(https://3.bp.blogspot.com/-K5anz5tYQuU/WHH4ccH7RVI/AAAAAAAADZI/6QiPryGZ_z4Xk9-jqi_sHtVqhyzhRGbHQCPcB/s1600/Arrows-RWhite-icon.png);background-repeat: no-repeat;';
